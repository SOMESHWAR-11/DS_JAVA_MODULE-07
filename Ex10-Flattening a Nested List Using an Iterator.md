...
## Algorithm
Start the program.
Parse string input into nested structure using stack.
Recursively flatten nested lists into a single list.
Use an iterator with pointer position to return elements sequentially.
...
```
## Output:
<img width="897" height="229" alt="image" src="https://github.com/user-attachments/assets/93c63d93-e8e1-43ad-9b29-772fb10ad1da" />
